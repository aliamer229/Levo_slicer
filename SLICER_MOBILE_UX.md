...
- The workspace opens immediately with a visible build plate and a large, explicit file-upload card.
...
- Cards, bars, dialogs, and native engine panels are opaque and consistent; there are no decorative gradients or backdrop blur.
